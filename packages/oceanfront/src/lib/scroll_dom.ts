/** Low-level DOM helpers shared by the virtual-scroll/speed-limit modules. */
...
/** Nearest ancestor that actually scrolls (or `window` if none does). */
...
/** Normalizes a wheel event's delta to CSS pixels regardless of `deltaMode`. */
